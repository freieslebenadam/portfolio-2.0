export default {
  ...
  sections: {
    ...
    skills: {
      title: "What I Can Do",
      description: "Primarily I develop front-end applications, but that doesn't mean I get lost in other branches. I love to learn new things and getting better with my productivity.",
      tabs: {
        frontend: "Front-End",
        backend: "Back-End",
        other: "Other"
